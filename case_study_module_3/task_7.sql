...
-- nhưng chưa từng được Khách hàng đặt phòng  trong năm 2019.
 select ser.id_service, ser.name_service, ser.area, ser.max_of_customer, 
		ser.rental_fee, tos.name_of_service, con.date_started_contract
 from services ser
...
where	ser.id_service  in (
    ...
    from contracts
    where year(con.date_started_contract) =2018
	)	
