...
select cus.id_customer, cus.fullname_customer, toc.type_of_customer_name, con.id_contract, ser.id_service
		, ser.name_service, con.date_started_contract,con.date_ended_contract,
