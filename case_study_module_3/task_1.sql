...
values ("massage", 100, 5, "available"),
...
values ('theo năm', 10000),
       ('theo ngày', 100),
       ('theo tháng', 500),
       ('theo giờ', 10);

insert into services (name_service, `area`, floors, max_of_customer, rental_fee, id_rental_type, id_service_type,
                      availability_status)
values ('Villa A', 150, 2, 8, 300, 1, 2, 'not available'),
...
values ('Tạ Giải Ngữ ', 1, 1, 3, '1991-12-12', 201457859, 2000, '0905456789', 'cong@gmail.com', ' Hải Phòng'),
...
values (1, 'Toàn Nguyen Văn ', '1987-6-12', 201523456, '0905222444', 'toan@gmail.com', 'Quảng Nam'),
...
insert into contracts(id_employee, id_customer, id_service, date_started_contract, date_ended_contract, deposits,
                      total_money)
values (1, 1, 1, "2018-12-12", "2019-03-12", 100, 500),
