...
where customers.id_customer in ( select customers.id_customer
    ...
    join accompanied_services acc on cd.id_accompanied_service = acc.id_accompanied_service
    where year(contracts.date_started_contract) = 2021 and customers.id_customer = 2
